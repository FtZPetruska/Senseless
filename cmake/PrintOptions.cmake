...
function(print_options_summary)
  ...
  print_option("SL_ENABLE_CCACHE" "${CCACHE}")
  print_option("SL_ENABLE_CLANG_TIDY" "${CLANG_TIDY}")
  print_option("SL_ENABLE_CLANG_FORMAT" "${CLANG_FORMAT}")
  print_option("SL_ENABLE_IWYU" "${IWYU}")
